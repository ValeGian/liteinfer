...
| | liteinfer | vLLM | |
|---|---:|---:|---|
| Throughput, B=32 | **3,374 tok/s** | 4,397 tok/s | 1.3× behind |
| Throughput, ISL 1024 / OSL 1024 | **2,535 tok/s** | 3,243 tok/s | 1.3× behind |
| Decode step (ITL p50) | **6.5 ms** | 5.2 ms | 1.3× behind |
| Time to first token (p50) | 14.7 ms | 22.4 ms | 1.5× ahead\* |
...
graph took the decode step **13.3 → 6.5 ms (2.0×)** and throughput **1,997 →
3,374 tok/s (1.7×)**, closing the gap to vLLM from 2.6× to 1.3× on the step. What
